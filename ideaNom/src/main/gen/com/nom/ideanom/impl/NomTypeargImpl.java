...
public class NomTypeargImpl extends ASTWrapperPsiElement implements NomTypearg {

  public NomTypeargImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NomType getType() {
    return findNotNullChildByClass(NomType.class);
  }
