...
public class NomInstanceassignmentImpl extends ASTWrapperPsiElement implements NomInstanceassignment {

  public NomInstanceassignmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NomVisitor visitor) {
    visitor.visitInstanceassignment(this);
  }
  ...
  public NomDefaultexpr getDefaultexpr() {
    return findNotNullChildByClass(NomDefaultexpr.class);
  }
