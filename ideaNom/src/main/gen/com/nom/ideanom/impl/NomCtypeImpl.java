...
public class NomCtypeImpl extends ASTWrapperPsiElement implements NomCtype {

  public NomCtypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NomTypeqname getTypeqname() {
    return findNotNullChildByClass(NomTypeqname.class);
  }
