...
public class NomDivmultopImpl extends ASTWrapperPsiElement implements NomDivmultop {

  public NomDivmultopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NomVisitor visitor) {
    visitor.visitDivmultop(this);
  }
