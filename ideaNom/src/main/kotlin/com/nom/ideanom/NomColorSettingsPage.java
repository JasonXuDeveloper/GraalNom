...
final class NomColorSettingsPage implements ColorSettingsPage {
    private static final AttributesDescriptor[] DESCRIPTORS = new AttributesDescriptor[]{
            new AttributesDescriptor("Key", NomSyntaxHighlighter.KEY),
            new AttributesDescriptor("Separator", NomSyntaxHighlighter.SEPARATOR),
            new AttributesDescriptor("Value", NomSyntaxHighlighter.VALUE),
