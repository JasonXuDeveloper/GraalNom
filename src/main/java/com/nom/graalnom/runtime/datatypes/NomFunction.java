...
public final class NomFunction implements TruffleObject {
    ...
    abstract static class Execute {
         ...
         * function is redefined, the call target maintained by the NomFunction object is changed. To
         * avoid a check for that, we use an Assumption that is invalidated by the NomFunction when
        ...
        @SuppressWarnings("unused")
        protected static Object doDirect(NomFunction function, Object[] arguments,
        ...
        protected static Object doIndirect(NomFunction function, Object[] arguments,
